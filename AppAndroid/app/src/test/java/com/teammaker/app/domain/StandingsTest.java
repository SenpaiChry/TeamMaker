...
/**
 * Test per Standings: catena tie-break punti -> vittorie -> quoziente set
...
public class StandingsTest {
    ...
    private static Match match(String team1Key, String team2Key, int setsTeam1, int setsTeam2) {
        return new Match(team1Key, team2Key, 1, "10:00", setsTeam1, setsTeam2, MatchPhases.GROUP);
    }
    ...
    public void orderTeams_emptyList_returnsEmpty() {
        List<Team> ordered = Standings.orderTeams(new ArrayList<>(), new ArrayList<>());
    ...
    public void orderTeams_singleTeam_returnsSame() {
        Team a = team("A");
        List<Team> ordered = Standings.orderTeams(
    ...
    public void twoTeamsPair_brokenByHeadToHead() {
        ...
        List<Standings.TeamStanding> standings = Standings.computeStandings(
    ...
    public void computeStandings_returnsPopulatedStats() {
        ...
        Standings.TeamStanding aStand = standings.get(0);
        ...
        Standings.TeamStanding bStand = standings.get(1);
    ...
    public void computeStandings_ignoresMatchesFromFinalPhase() {
        ...
        Team a = team("A");
        Team b = team("B");
        Match finalMatch = new Match("A", "B", 1, "10:00", 3, 0, MatchPhases.FINAL);
        List<Standings.TeamStanding> standings = Standings.computeStandings(
