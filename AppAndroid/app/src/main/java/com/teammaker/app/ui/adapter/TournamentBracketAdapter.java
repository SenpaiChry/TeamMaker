...
import com.teammaker.app.ui.popup.InfoMatchPopupActivity;
...
public class TournamentBracketAdapter extends RecyclerView.Adapter<TournamentBracketAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder h, int position) {
        ...
        String phaseLabel = MatchPhases.label(context, match.type);
        ...
        h.txtTeam1.setText(MatchLabels.teamOrPlaceholder(context, activeTournament, match, 1));
        h.txtTeam2.setText(MatchLabels.teamOrPlaceholder(context, activeTournament, match, 2));
        ...
        h.btnInfo.setOnClickListener(v -> {
            Intent intent = new Intent(context.getApplicationContext(), InfoMatchPopupActivity.class);
    ...
    private boolean teamMatchesQuery(String keyTeam) {
        ...
        Team team = TeamRepository.getTeamByKey(keyTeam);
