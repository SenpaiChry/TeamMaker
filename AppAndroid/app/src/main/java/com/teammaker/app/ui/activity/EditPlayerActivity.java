...
import com.teammaker.app.ui.adapter.StatsPlayerAdapter;
        ...
        switch (key) {
            case "null": { // NEW
                ...
                btnConfirm.setOnClickListener(view -> {
                    if (!String.valueOf(txtName.getText()).isEmpty() && player.gender != null && (player.gender.equals("F") || player.gender.equals("M"))) {
                        ...
                        PlayerRepository.addPlayer(playerTemp, success -> {
                            runOnUiThread(() -> {
                                if (success) {
                                    TopToast.show(this,
            ...
            default: { // EDIT
                ...
                btnConfirm.setOnClickListener(view -> {
                    ...
                    PlayerRepository.addEditPlayer(playerTemp, player.key);
                    finish();
                });
