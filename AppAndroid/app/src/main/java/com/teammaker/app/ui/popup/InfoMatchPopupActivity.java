...
public class InfoMatchPopupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() != null) {
            ...
            Match match = TournamentRepository.getActiveTournament()
            ...
            txtType.setText(MatchPhases.label(this, match.type));
            ...
            txtTeam1.setText(MatchLabels.teamOrPlaceholder(this, TournamentRepository.getActiveTournament(), match, 1));
            txtTeam2.setText(MatchLabels.teamOrPlaceholder(this, TournamentRepository.getActiveTournament(), match, 2));
            ...
            fillPlayers(TeamRepository.getTeamByKey(match.keyTeam1), team1PlayerIds);
            fillPlayers(TeamRepository.getTeamByKey(match.keyTeam2), team2PlayerIds);
        }
