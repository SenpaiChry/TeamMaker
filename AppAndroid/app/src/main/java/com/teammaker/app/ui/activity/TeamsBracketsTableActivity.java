...
import com.teammaker.app.ui.adapter.TournamentBracketAdapter;
import com.teammaker.app.ui.adapter.TournamentTableAdapter;
import com.teammaker.app.ui.adapter.TournamentTeamsAdapter;
import com.teammaker.app.R;

public class TeamsBracketsTableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tournamentToShow = TournamentRepository.getActiveTournament();
    ...
    private void applySearch(String query) {
        ...
        for (Match match : tournamentToShow.matches) {
            Team team1 = TeamRepository.getTeamByKey(match.keyTeam1);
            Team team2 = TeamRepository.getTeamByKey(match.keyTeam2);
