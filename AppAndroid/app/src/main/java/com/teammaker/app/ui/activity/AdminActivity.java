...
public class AdminActivity extends AppCompatActivity {
    ...
    // Chi ne ha bisogno usa AdminActivity.get() e controlla null.
    private static WeakReference<AdminActivity> instance = new WeakReference<>(null);
    public static AdminActivity get() { return instance.get(); }
    ...
    private void exportPlayers() {
        try {
            ...
            Log.e("AdminActivity", "Export fallito", e);
