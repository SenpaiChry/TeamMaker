...
public class EditTeamPopupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tournament tournament = TournamentRepository.getTournamentByKey(getIntent().getExtras().getString("tournament_key"));
        ...
        if (getIntent().getExtras().getString("team_key").equals("null")) { // NEW
            ...
            btnConfirm.setOnClickListener(view -> {
                ...
                if (!team.players.isEmpty()) {
                    TeamRepository.addTeamToTournament(tournament.key, team);
                    finish();
                } else {
        ...
        else // EDIT
        {
            ...
            Team teamOriginal = TeamRepository.getTeamByKey(getIntent().getExtras().getString("team_key"));
            ...
            btnConfirm.setOnClickListener(view -> {
                ...
                if (checkEditedTeam(tournament, teamEdited, teamOriginal)) {
                    TeamRepository.editTeamsTournament(tournament);
