...
public class ManageTournamentPopupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtDate.setOnClickListener(v -> {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(ManageTournamentPopupActivity.this,
        ...
        btnCopyMatches.setOnClickListener(v -> {
            ...
            for (Match match : matches) {
                textToCopy.append(getString(R.string.match)).append(" ").append(tournament.getNMatchByKey(match.key))
                        ...
                        .append(" (").append(MatchPhases.label(this, match.type)).append("): ")
        ...
        btnLockToggle.setOnClickListener(v -> {
            ...
            TournamentRepository.setLocked(tournament.key, newLocked);
    ...
    private void openActivityManageMatches(String tournamentKey) {
        Intent intent = new Intent(this, ManageMatchesActivity.class);
        intent.putExtra("tournament_key", tournamentKey);
        startActivity(intent);
    }
