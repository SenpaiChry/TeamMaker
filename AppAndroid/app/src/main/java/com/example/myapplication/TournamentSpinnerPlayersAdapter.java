...
public class TournamentSpinnerPlayersAdapter extends ArrayAdapter<String> {
    private final Context context;
    private final ArrayList<String> values;

    public TournamentSpinnerPlayersAdapter(Context context, ArrayList<String> values) {
